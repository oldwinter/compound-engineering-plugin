...
> **中文导读：** Interactive mode 执行任何 bulk action 前，先给单屏 preview；每条 finding 遵循 shared rendering floor，以 recommendation 和 plain-language consequence 开头，再给必要 evidence/mechanism，最后只提供 Proceed 或 Cancel。
