...
> **中文导读：** Interactive walk-through 每次只呈现一个 finding，并按 shared rendering floor 组织：recommendation、plain-language consequence、evidence、options、最后才是简短 mechanism。所有 terminal paths 使用同一 completion report。
