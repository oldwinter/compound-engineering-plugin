...
> **中文导读：** Deepening 只在 confidence gate 触发时加载。新 contract 要求把 Product Contract 的 rule ownership 和 `Governs R...` relationships 带入 gap scoring，不能在 planning layer 重新陈述同一 requirement。
