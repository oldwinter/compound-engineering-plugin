...
本 reference 面向 Durable path，管理 plan 写完后的 document review、post-generation options 与 issue creation。下方英文是 canonical executable contract，命令、参数、路由条件和跨 host 行为保持原样。
