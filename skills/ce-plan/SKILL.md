...
Document review is mandatory. The default is non-interactive (`mode:non-interactive`); users may opt into the interactive walkthrough from the post-generation menu.
