...
Dispatch `ce-learnings-researcher` 搜索 similar topics 上的 prior optimization work。如果 relevant learnings 存在，将它们纳入 approach。
...
如果 scope large 或 unfamiliar，可 optionally dispatch `ce-repo-research-analyst` 进行 deeper codebase analysis。
