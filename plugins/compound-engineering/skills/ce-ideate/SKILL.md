...
**Enrichment, not substitution。** 用户提供的 research artifact 不替代 `ce-web-researcher` dispatch：这些 artifacts 通常覆盖 web research 抵达不了的 source classes（social platforms、niche communities、prediction markets、short-video），反之亦然。正常 dispatch web research。
