...
description: "对 repository structure、documentation、conventions 和 implementation patterns 做 thorough research。用于 onboarding 到新 codebase，或理解 project conventions。"
model: inherit
