...
description: Conditional code-review persona，在 review 带 existing review comments 或 review threads 的 PR 时选择。检查 prior feedback 是否已在 current diff 中 addressed。
model: inherit
