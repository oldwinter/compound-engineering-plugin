...
description: "评估 planning documents 中提出的 technical approaches 是否能经受现实检验，包括 architecture conflicts、dependency gaps、migration risks 和 implementability。由 document-review skill 派发。"
model: inherit
