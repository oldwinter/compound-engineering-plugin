...
description: Conditional code-review persona；当 diff 触及 async UI code、Stimulus/Turbo lifecycles 或 DOM-timing-sensitive frontend behavior 时选择。review code 中的 race conditions 和 janky UI failure modes。
model: inherit
