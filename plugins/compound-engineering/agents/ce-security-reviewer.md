...
description: Conditional code-review persona；当 diff 触及 auth middleware、public endpoints、user input handling 或 permission checks 时选择。review code 中可被利用的 vulnerabilities。
model: inherit
