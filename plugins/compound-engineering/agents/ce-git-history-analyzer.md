...
description: "对 git history 做 archaeological analysis，追踪 code evolution、识别 contributors，并理解 code patterns 为什么存在。需要 code changes 的 historical context 时使用。"
model: inherit
