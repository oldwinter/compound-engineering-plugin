...
description: Conditional code-review persona；当 diff 触及 database queries、loop-heavy data transforms、caching layers 或 I/O-intensive paths 时选择。review code 的 runtime performance 和 scalability issues。
model: inherit
