...
description: Always-on code-review persona。审查 code 的 structural quality、complexity deletion、coupling、naming、dead code、type-boundary leaks 和 abstraction debt。
model: inherit
