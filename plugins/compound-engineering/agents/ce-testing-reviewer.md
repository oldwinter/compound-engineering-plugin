...
description: Always-on code-review persona。review code 中的 test coverage gaps、weak assertions、brittle implementation-coupled tests 和 missing edge case coverage。
model: inherit
