...
description: 条件性 code-review persona；当 diff 触及 Swift files、SwiftUI/UIKit views、iOS entitlements、privacy manifests、Core Data models、SPM manifests、storyboards/XIBs 或 semantic .pbxproj changes 时选择。审查 SwiftUI correctness、state management、memory safety、Swift concurrency、Core Data threading 和 accessibility。
model: inherit
